...
namespace Terrain {
	...
	namespace Presets {
		...
		static constexpr NoiseSettings niceLumpyHills = NoiseSettings{
			.seed = 1337,
			.frequency = 0.009f,
			.noise_type = FastNoiseLite::NoiseType_Perlin,
			.noise_exp = 1.0f,
		...
		static constexpr NoiseSettings singleBigHill = NoiseSettings{
			.seed = 1337,
			.frequency = 0.011f,
			.noise_type = FastNoiseLite::NoiseType_OpenSimplex2S,
			.noise_exp = 1.0f,

			.fractal_type = FastNoiseLite::FractalType_PingPong,
			.fractal_octaves = 3,
			.fractal_lacunarity = 0.34f,
			.fractal_gain = 3.0f,
			.fractal_weighted_strength = 0.0f,
			.fractal_pingpong_strength = 2.0f,
